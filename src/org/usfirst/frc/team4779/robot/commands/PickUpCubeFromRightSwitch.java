...
public class PickUpCubeFromRightSwitch extends CommandGroup {
    ...
    public PickUpCubeFromRightSwitch() {
    	...
    	addSequential(new DriveStraightPIDWithThrottle(RobotMap.SWITCH_BACKUP_DISTANCE, RobotMap.THROTTLE_SPEED, RobotMap.REVERSE, false, RobotMap.NORTH));
    	//Drive towards the pile at an angle and turn on vacube
    	addParallel(new DriveStraightPIDWithThrottle(RobotMap.CUBE_PILE_APPROACH_DISTANCE, RobotMap.THROTTLE_SPEED, RobotMap.FORWARD, false, RobotMap.NORTHWEST));
    	addSequential(new VacCubeIntakeWithSensor());
    	//Backup after grabbing cube then Drive Forward
    	addSequential(new DriveStraightPIDWithThrottle(RobotMap.CUBE_PILE_APPROACH_DISTANCE, RobotMap.THROTTLE_SPEED, RobotMap.REVERSE, false, RobotMap.NORTHWEST));
    	addParallel(new DriveStraightPIDWithThrottle(RobotMap.SWITCH_BACKUP_DISTANCE, RobotMap.THROTTLE_SPEED, RobotMap.FORWARD, false, RobotMap.NORTH));
